...
export const ExpenseTrend = ({ data, isLoading }: Props) => {
  ...
  if (isLoading) {
    return (
     <div className="w-full rounded-[1.6rem] md:rounded-[2rem] p-4 md:p-6 bg-[var(--color-surface)] border border-[var(--border)] shadow-sm flex flex-col gap-6 h-full">
  {/* Header Skeleton */}
  ...
  if (!hasData) {
    return (
      <div className="w-full rounded-[1.6rem] md:rounded-[2rem] p-4 md:p-6 bg-[var(--color-surface)] border border-[var(--border)] shadow-sm flex flex-col gap-6 items-center justify-center text-center min-h-[320px] h-full">
  ...
  return (
    <div className="w-full rounded-[1.6rem] md:rounded-[2rem] p-4 md:p-6 bg-[var(--color-surface)] border border-[var(--border)] shadow-sm hover:shadow-md transition-all flex flex-col gap-6 h-full">
