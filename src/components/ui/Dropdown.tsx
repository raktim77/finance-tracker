  ...
  return (
    <div ref={ref} className={`relative ${className}`}>
      ...
      <button
        ...
        className={`w-full flex items-center justify-between bg-[var(--color-surface)] border font-bold transition-all hover:border-[var(--color-accent)]/30 border-[var(--color-accent)]/20 ${
          compact
      ...
      {open &&
        createPortal(
          <div
            ...
            className={`bg-[var(--color-surface)] border border-[var(--input-border)] shadow-xl overflow-y-auto overscroll-contain z-[9999] animate-in fade-in slide-in-from-top-1 ${
              compact
                ? "max-h-56 rounded-lg"
