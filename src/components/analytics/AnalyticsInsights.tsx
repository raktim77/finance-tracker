...
export function AnalyticsInsights() {
  return (
    <div className="lg:col-span-6 rounded-2xl  p-6 bg-[var(--color-surface)] border border-[var(--border)] shadow-xs relative overflow-hidden min-h-[200px] md:min-h-[240px] flex flex-col justify-center transition-all gap-4 md:gap:0">
      ...
      <div className="relative z-10 opacity-80 grayscale flex items-center justify-between">
        ...
        <div className="px-2 py-2 rounded-full border border-[var(--border)] bg-[var(--color-background)] shrink-0 flex items-center justify-between">
