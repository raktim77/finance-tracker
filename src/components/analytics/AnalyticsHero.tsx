...
const safeBudget = Math.min(budgetUsed, 100);
  ...
  return (
    <div className="relative w-full max-w-full">
      <div className="relative z-0 group overflow-hidden rounded-[2.5rem] p-6 md:p-12 bg-gradient-to-br from-[#7c6cff] via-[#9c7cff] to-[#c084fc] shadow-2xl/50 transition-all duration-500">
        ...
        <div className="relative z-10 flex flex-col md:flex-row  justify-between gap-8 md:gap-12 text-white">
          <div className="flex flex-col gap-2">
            ...
            <div className="flex items-baseline gap-2">
              <span className="text-3xl md:text-5xl font-black tracking-tighter md:block hidden">₹{totalSpending.toLocaleString()}</span>
              <span className="text-3xl md:text-5xl font-black tracking-tighter md:hidden block">₹{formatCompactCurrency(totalSpending)}</span>
