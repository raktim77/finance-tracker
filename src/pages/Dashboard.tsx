        ...
        <div className="relative z-10 flex flex-col md:flex-row justify-between md:items-center gap-8">
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <span className="text-2xl md:text-5xl font-black text-white tracking-tight leading-none">
                ₹1,24,500
              </span>
            </div>
          </div>
          <div className="hidden lg:flex gap-3">
            <button className="flex items-center gap-2 bg-white text-[var(--color-accent)] px-6 py-3 rounded-2xl text-sm font-black shadow-xl hover:shadow-2xl active:scale-95 transition-all hover:bg-[var(--color-accent)] hover:text-white">
